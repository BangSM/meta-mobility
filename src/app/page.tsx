...
export default function Home() {
  return (
    <div className="flex flex-col items-center w-full h-full min-h-[8324px] bg_1">
      <Navi />
      <main className="mx-auto min-w-[1024px] z-999">
        <section id="home" className="flex gap-[35px] pt-[134px] flex-col items-center  h-[1018px] mb-[80px] ">
          ...
          <a
            className="flex btn_gradient_1 h-[36px] border rounded-[29px] text-white text-[10px] font-light leading-[20px] tracking-[-0.1px] px-[25px] items-center cursor-pointer z-999"
        ...
        <section className="flex flex-col items-center gap-[15px] mb-[462px]">
        ...
        <section id="ELI-CARE" className="relative overflow-x-hidden flex items-center gap-[15px] mb-[500px]">
          <div className="flex flex-col gap-[30px]">
            <div className="flex flex-col gap-[35px] pl-[180px]">
              ...
              <p className="text-[30px] font-light leading-[45px] tracking-[-0.1px] whitespace-pre text-white">
        ...
        <section id="OUR-CORE" className="flex flex-col items-center gap-[40px] mb-[381px]">
          <div className="flex flex-col gap-[50px] items-center ">
            <div className="flex gap-[24px]">
              <div className="flex flex-col border border-white rounded-[21px] px-[22px] w-[311px] h-[173px] bg_gradient_5">
                <div className="flex items-center gap-[15px] mt-[20px]">
                  <span className="text-[15px] font-normal leading-[45px] tracking-[-0.1px]">#1</span>
                  <span className="text-[15px] font-normal leading-[45px] tracking-[-0.1px]">
                    Ultra - Speed Capture
                  </span>
                </div>
                <p className="flex justify-center text-[10px] font-light leading-[15px] tracking-[-0.1px] text-justify text-white">
                  We record electrical signals at an ultra-high- speed 20-nanosecond resolution, enabling the detection
                  of even the most fleeting anomaly patterns. This precision provides engineers with highly granular
                  data that conventional logging systems simply cannot match, forming the foundation for accurate
                  diagnostics and prediction.
                </p>
              </div>
              <div className="flex flex-col  border border-white rounded-[21px] px-[22px] w-[311px] h-[173px] bg_gradient_5">
                <div className="flex items-center gap-[15px] mt-[20px]">
                  <span className="text-[15px] font-normal leading-[45px] tracking-[-0.1px]">#2</span>
                  <span className="text-[15px] font-normal leading-[45px] tracking-[-0.1px]">AI Anomaly Detection</span>
                </div>
                <p className="flex justify-center text-[10px] font-light leading-[15px] tracking-[-0.1px] text-justify text-white">
            ...
            <div id="OUR-CORE" className="flex flex-col gap-[15px] items-center ">
            ...
            <div className="flex gap-[24px]">
              <div className="flex flex-col border border-white rounded-[21px] px-[22px] w-[311px] h-[173px] bg_gradient_5">
                <div className="flex items-center gap-[15px] mt-[20px]">
                  <span className="text-[15px] font-normal leading-[45px] tracking-[-0.1px]">#3</span>
                  <span className="text-[15px] font-normal leading-[45px] tracking-[-0.1px]">Predict Earlier</span>
                </div>
                <p className="flex justify-center text-[10px] font-light leading-[15px] tracking-[-0.1px] text-justify text-white">
                  We forecast failures faster than CAN, impedance, or IR-based diagnostics, which often detect issues
                  only after degradation has progressed. Our method shortens the reaction window, giving operators
                  valuable time to act and prevent costly downtime or safety incidents.
                </p>
              </div>
              <div className="flex flex-col border border-white rounded-[21px] px-[22px] w-[311px] h-[173px] bg_gradient_5">
                <div className="flex items-center gap-[15px] mt-[20px]">
                  <span className="text-[15px] font-normal leading-[45px] tracking-[-0.1px]">#4</span>
                  <span className="text-[15px] font-normal leading-[45px] tracking-[-0.1px]">
              ...
              <div className="flex border-[0.5] rounded-[21px] border-white w-[424px] h-[174px] bg_gradient_5 p-[17px] gap-[10px]">
                ...
                <div className="relative flex flex-col justify-between w-[254px]">
                  ...
                  <div className="flex flex-col pt-[13px]">
                    <strong className="text-[14px] font-normal text-white leading-[25px] tracking-[-0.1px]">
                      Jiwon
                    </strong>
                    <span className="text-[14px] font-light text-white leading-[25px] tracking-[-0.1px]">CEO</span>
                  </div>
                  <div className="flex flex-col">
                    <div className="flex justify-between">
                      <span className="text-[10px] font-light text-white leading-[15px] tracking-[-0.1px] text-justify">
                        N3 Capital Partners PE
                      </span>
                      <span className="text-[10px] font-normal text-white leading-[15px] tracking-[-0.1px] text-justify">
                        Adivisor
                      </span>
                    </div>
                    <div className="flex justify-between">
              ...
              <div className="flex flex-col gap-[15px] border-[0.5] rounded-[21px] border-white w-[203px] h-[174px] bg_gradient_5 pt-[17px] pl-[16px]">
                <div className="flex gap-[10px]">
                  ...
                  <div className="relative flex flex-col pt-[13px]">
                    ...
                    <strong className="text-[14px] font-normal leading-[25px] tracking-[-0.1px] text-white">
                      Jaehwan
                    </strong>
                    <span className="text-[14px] font-light leading-[25px] tracking-[-0.1px] text-white">COO</span>
                  </div>
                </div>
                <div className="flex flex-col w-[164px]">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-light leading-[15px] tracking-[-0.1px] text-white">
                      Geumseong Law firm
                    </span>
                    <span className="text-[10px] font-normal leading-[15px] tracking-[-0.1px] text-white ">
                      Partner
                    </span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-[10px] font-normal leading-[15px] tracking-[-0.1px] text-white">B.A</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col gap-[15px] border-[0.5] rounded-[21px] border-white w-[203px] h-[174px] bg_gradient_5 pt-[17px] pl-[16px]">
                <div className="flex gap-[7px]">
                  ...
                  <div className="relative flex flex-col pt-[13px]">
                    ...
                    <span className="text-[14px] font-light leading-[25px] tracking-[-0.1px] text-white">CTO</span>
                  </div>
                </div>
                <div className="flex flex-col w-[164px]">
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex justify-between">
                    <span className="text-[10px] font-light leading-[15px] tracking-[-0.1px] text-white">MIT</span>
                    <span className="text-[10px] font-normal leading-[15px] tracking-[-0.1px] text-white">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-[10px] font-normal leading-[15px] tracking-[-0.1px] text-white ">Ph.D</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-[10px] font-light leading-[15px] tracking-[-0.1px] text-white">
                      Korea University
                    </span>
                    <span className="text-[10px] font-normal leading-[15px] tracking-[-0.1px] text-white">B.S</span>
                  </div>
                </div>
              </div>
              <div className="flex flex-col gap-[15px] border-[0.5] rounded-[21px] border-white w-[203px] h-[174px] bg_gradient_5 pt-[17px] pl-[16px]">
                <div className="flex gap-[7px]">
                  ...
                  <div className="relative flex flex-col pt-[13px]">
                    ...
                    <span className="text-[14px] font-light leading-[25px] tracking-[-0.1px] text-white">
                      Senior engineer
                    </span>
                  </div>
                </div>
                <div className="flex flex-col w-[164px]">
                  ...
                  <div className="flex justify-between">
                    <span className="text-[10px] font-light leading-[15px] tracking-[-0.1px] text-white">RVSST</span>
                    <span className="text-[10px] font-normal leading-[15px] tracking-[-0.1px] text-white">
                      Technical Director
                    </span>
                  </div>
              ...
              <div className="flex flex-col gap-[15px] border-[0.5] rounded-[21px] border-white w-[203px] h-[174px] bg_gradient_5 pt-[17px] pl-[16px]">
                <div className="flex gap-[7px]">
                  ...
                  <div className="relative flex flex-col pt-[15px]">
                    ...
                    <span className="text-[14px] font-light leading-[15px] tracking-[-0.1px] whitespace-pre text-white">
                      {`Business Dev.\nTeam Manager`}
                    </span>
                  </div>
                </div>
                <div className="flex flex-col w-[164px]">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-light leading-[15px] tracking-[-0.1px] text-white">Hansol</span>
                    <span className="text-[10px] font-normal leading-[15px] tracking-[-0.1px] text-white">
                      Team Manager
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-[10px] font-light leading-[15px] tracking-[-0.1px] text-white">PA-O</span>
                    <span className="text-[10px] font-normal leading-[15px] tracking-[-0.1px] text-white">Manager</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-[10px] font-light leading-[15px] tracking-[-0.1px] text-white">
                      Chongshin University
                    </span>
                    <span className="text-[10px] font-normal leading-[15px] tracking-[-0.1px] text-white">M.A</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-[10px] font-light leading-[15px] tracking-[-0.1px] text-white">
                      Inha University
        ...
        <section id="INQUIRY" className="flex flex-col items-center gap-[50px]">
          <div className="flex flex-col gap-[50px] items-center">
            <div className="flex flex-col gap-[15px] items-center ">
          ...
          <Form />
          <footer className="relative flex flex-col items-center gap-[35px] mt-[200px] z-999  ">
            <div className="flex gap-[48px] items-center w-[100%]">
