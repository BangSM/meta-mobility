...
const Navi = () => {
  ...
  return (
    <nav className="flex sticky top-0 h-[115px] w-full bg-[#000] pt-[40px] z-999">
      <div className="flex w-full justify-between items-center px-[78px]">
        <button
        ...
        <div className="flex items-center gap-[57px] h-[45px]">
          ...
          <div className="relative flex flex-col">
            ...
            {isOpen && (
              <div className="absolute bottom-[-165px] left-[-20px]  bg-black z-200">
